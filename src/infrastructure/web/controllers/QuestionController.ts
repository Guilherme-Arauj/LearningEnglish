...
import { QuestionDTO } from "../../../application/dto/question/QuestionDTO";
...
import { QuestionUpdateDTO } from "../../../application/dto/question/QuestionUpdateDTO";
import { validateDTODeleteQuestion } from "../../utils/zod/validateDTODeleteQuestion";
import { DeleteQuestionDTO } from "../../../application/dto/question/DeleteQuestionDTO";
import { validateDTOAnswerQuestion } from "../../utils/zod/validateDTOAnswerQuestion";
import { AnswerQuestionDTO } from "../../../application/dto/question/AnswerQuestionDTO";
...
export class QuestionController {
  ...
  public async answerQuestion(req: Request, res: Response): Promise<any> {
    try {
      ...
      const dto = new AnswerQuestionDTO(
      ...
      res.status(200).json({
        success: true,
        message: answerQuestion.correct
          ? "Resposta correta!"
          : "Resposta incorreta!",
        data: {
          correct: answerQuestion.correct,
          ...(answerQuestion.correctAnswer && {
            correctAnswer: answerQuestion.correctAnswer,
          }),
        },
      });
    } catch (error) {
